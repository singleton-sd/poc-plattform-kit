...
section 3, section 5, and section 6 operationally. Read the policy document for the full rules;
...
4. Once none of those three labels apply, run the handoff gate to confirm
   ...
   [`docs/pr-pipelines.md`](docs/pr-pipelines.md)'s "Enforced PR handoff
   gate" section). It removes the label if any blocker reappears.
...
[`docs/pr-pipelines.md`](docs/pr-pipelines.md)'s "Issue closure (GitHub-native)" section.
