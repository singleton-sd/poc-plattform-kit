...
Each ticket description must include `[repo=singleton-sd/poc-plattform-kit]` when created in ClickUp; keep it out of the task name. These are proposed slices for consolidation; this discovery agent does not create or claim them.
