...
5. In one Support transaction, supersede any actor's older active session, create the session, local Audit and Outbox event. Generate/set the cookie only after commit.
