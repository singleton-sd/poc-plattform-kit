...
1. **PR open/sync** (paths `apps/api/**`, `pillars/**`, `packages/**`):
   - Resolve `PREVIEW_SEED_SCENARIOS` from the PR body (`<!-- preview-scenarios: name1, name2 -->`, defaulting to `demo` — see [`docs/preview-scenarios.md`](../docs/preview-scenarios.md)).
