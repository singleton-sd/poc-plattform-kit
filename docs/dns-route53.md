...
Forward Email uses a **separate** mail hostname (`mail.plattform-kit.poc.singletonsd.com`) so MX/TXT do not collide with the marketing CNAME — see [email-forward-email.md](./email-forward-email.md) (Path B topology).
