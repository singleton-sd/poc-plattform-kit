...
| --- | --- | --- |
| **ClickUp** | Product features the user describes; private business/commercial planning: business ideas, commercial strategy, pricing, sales information, customer-private information, contracts, commercially sensitive roadmap, other private business planning; optional **tracking** tickets for ad-hoc work. | Anything in the engineering execution lifecycle: no engineering task status, no engineering dependency tracking, no agent claim/handoff state. |
...
| `.cursor/skills/task-management/SKILL.md` (and peers) | Historical ClickUp-centric copies under `.cursor/skills/` | [#173](https://github.com/singleton-sd/poc-plattform-kit/issues/173) / [#284](https://github.com/singleton-sd/poc-plattform-kit/issues/284) — upstream skills + `.skills/manifest` install |
