...
When reviewing Prisma / `packages/db` changes, also apply [`packages/db/.cursor/BUGBOT.md`](../packages/db/.cursor/BUGBOT.md) (fuller mirror: [`docs/db-practices.md`](../docs/db-practices.md)).
